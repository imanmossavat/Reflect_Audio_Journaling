"""Generate the BASELINE (Maya) note corpus -> datasets/baseline/notes.json.

Single-note-answer set: most questions are answerable from one note. Kept as the
"easy" retrieval baseline. The harder, state-evolution set lives in datasets/stateful/.

Run:  python datasets/baseline/generate.py [--force]
"""
import sys
from pathlib import Path

# This generator lives next to its data, but reuses the harness bootstrap (Backend sys.path).
...
EVENTS = [
    {"note_id": "N-7811", "timestamp": "2026-05-12T22:14:00", "story_arc_id": "ARC_PROMOTION",
     ...
     "entities": ["Lina Mourad"], "tags": ["promotion", "Notion", "avoidance"]},
    {"note_id": "N-7812", "timestamp": "2026-05-13T09:22:00", "story_arc_id": "ARC_APARTMENT",
     ...
     "entities": ["Karel", "Tom Janssen"], "tags": ["mold", "landlord", "documentation"]},
    {"note_id": "N-7813", "timestamp": "2026-05-14T20:05:00", "story_arc_id": "ARC_CREATIVE",
     ...
     "entities": ["Yuki"], "tags": ["illustration", "Discord", "late night"]},
    {"note_id": "N-7814", "timestamp": "2026-05-17T08:41:00", "story_arc_id": "ARC_HEALTH",
     ...
     "entities": ["Bram"], "tags": ["physio", "distraction", "habits"]},
    {"note_id": "N-7815", "timestamp": "2026-05-19T23:48:00", "story_arc_id": "ARC_PROMOTION",
     ...
     "entities": ["Lina Mourad"], "tags": ["communication", "tone", "avoidance", "drafts"]},
    {"note_id": "N-7816", "timestamp": "2026-05-20T18:30:00", "story_arc_id": "ARC_FAMILY",
     ...
     "entities": ["Eva de Vries", "Tom Janssen"], "tags": ["money", "Eva", "hidden", "household"]},
    {"note_id": "N-7817", "timestamp": "2026-05-21T11:02:00", "story_arc_id": "ARC_HEALTH",
     ...
     "entities": ["Nora"], "tags": ["dentist", "inbox", "admin"]},
    {"note_id": "N-7818", "timestamp": "2026-05-22T21:17:00", "story_arc_id": "ARC_APARTMENT",
     ...
     "entities": [], "tags": ["mortgage", "spreadsheet", "rumination"]},
    {"note_id": "N-7819", "timestamp": "2026-05-15T19:55:00", "story_arc_id": "ARC_FAMILY",
     ...
     "entities": ["Hans de Vries"], "tags": ["family", "phone call", "Breda", "visit"]},
    {"note_id": "N-7820", "timestamp": "2026-05-12T07:35:00", "story_arc_id": "ARC_HEALTH",
     "summary": "Tuesday swim again skipped. Pool bag is still by the door from last week, unopened.",
     "entities": [], "tags": ["swim", "missed routine"]},
    {"note_id": "N-7821", "timestamp": "2026-05-13T20:11:00", "story_arc_id": "ARC_HEALTH",
     ...
     "entities": [], "tags": ["sleep", "tracking"]},
    {"note_id": "N-7822", "timestamp": "2026-05-14T12:48:00", "story_arc_id": "ARC_FAMILY",
     ...
     "entities": ["Eva de Vries"], "tags": ["voice message", "Eva"]},
    {"note_id": "N-7823", "timestamp": "2026-05-16T15:20:00", "story_arc_id": "ARC_CREATIVE",
     "summary": "Cleaned the iPad screen. Did not open Procreate.",
     "entities": [], "tags": ["illustration", "iPad", "avoidance"]},
    {"note_id": "N-7824", "timestamp": "2026-05-17T13:30:00", "story_arc_id": "ARC_FAMILY",
     ...
     "entities": [], "tags": ["Miso", "cat", "vet"]},
    {"note_id": "N-7825", "timestamp": "2026-05-18T22:02:00", "story_arc_id": "ARC_PROMOTION",
     "summary": "Saw a post from Mira about burnout recovery. Thought about it for a while. Did not bookmark it.",
     "entities": ["Mira"], "tags": ["burnout", "Mira"]},
    {"note_id": "N-7826", "timestamp": "2026-05-20T09:14:00", "story_arc_id": "ARC_APARTMENT",
     ...
     "entities": ["Tom Janssen"], "tags": ["mold", "dehumidifier"]},
    {"note_id": "N-7827", "timestamp": "2026-05-21T19:48:00", "story_arc_id": "ARC_CREATIVE",
     ...
     "entities": ["Sophie"], "tags": ["Sophie", "voice message", "Copenhagen"]},
    {"note_id": "N-7828", "timestamp": "2026-05-22T08:55:00", "story_arc_id": "ARC_PROMOTION",
     "summary": "Ruben's old slack handle now says Inactive User. Maya hovers over it sometimes.",
     "entities": ["Ruben"], "tags": ["work", "Ruben"]},
    {"note_id": "N-7829", "timestamp": "2026-05-23T11:40:00", "story_arc_id": "ARC_APARTMENT",
     "summary": "Borrowed Anika's drill again to redo one of the kitchen shelf anchors. The uneven shelf is still uneven.",
     "entities": ["Anika"], "tags": ["kitchen shelves", "Anika", "drill"]},
    {"note_id": "N-7830", "timestamp": "2026-05-24T13:18:00", "story_arc_id": "ARC_HEALTH",
     ...
     "entities": ["Tom Janssen"], "tags": ["tax", "draft", "admin"]},
    {"note_id": "N-7831", "timestamp": "2026-05-25T22:30:00", "story_arc_id": "ARC_HEALTH",
     "summary": "ADHD intake form open in a tab. Open in a tab for the second time this month. Did not fill anything in.",
     "entities": [], "tags": ["ADHD", "intake", "avoidance"]},
    {"note_id": "N-7832", "timestamp": "2026-05-18T07:50:00", "story_arc_id": "ARC_FAMILY",
     ...
     "entities": ["Daan Peters"], "tags": ["Daan", "money", "Portugal"]},
]
